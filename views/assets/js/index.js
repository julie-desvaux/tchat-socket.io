...
// Message Entête d'un utilisateur parti
function messageUserLeft(usernameLeft) {
  let message = '<div class ="conversation-start"><span>' + usernameLeft + ' est parti(e) !</span></div>'
  globalChat.insertAdjacentHTML('beforeend', message)
}
